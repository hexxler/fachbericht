...
\begin{document}
	...
	\par Im Rahmen der Produktvision beschränken sich die Hauptfeatures auf eines MVP. \improvement{Glossar MVP} Für die Realisierung eines MVP ist die Umsetzung der folgenden Bedingungen zwingend:
	\begin{itemize}
		\item Hauptmenü
		\begin{itemize}
			\item Partie starten
	...
	\begin{itemize}
		\item Der Code wurde einem Peer-Review unterzogen. \improvement{Glossar Peer-Review}
