...
\begin{document}
	...
	\subfile{sections/produktidee}
	\subfile{sections/spielregeln}
	\subfile{sections/umsetzung}
	\subfile{sections/risiken}
	\subfile{sections/architektur}
	\subfile{sections/technologien}
	\subfile{sections/miscellaneous}	%\subfile{sections/context}
